...
var gliderGun = {'1,5':[1, 5], '2,5':[2, 5], '2,6':[2, 6], '1,6':[1, 6], '11,5':[11, 5], '11,6':[11, 6], '11,7':[11, 7], '12,4':[12, 4], '12,8':[12, 8], '13,9':[13, 9], '14,9':[14, 9], '13,3':[13, 3], '14,3':[14, 3], '15,6':[15, 6], '16,4':[16, 4], '17,5':[17, 5], '17,6':[17, 6], '17,7':[17, 7], '18,6':[18, 6], '16,8':[16, 8], '21,5':[21, 5], '21,4':[21, 4], '22,5':[22, 5], '22,4':[22, 4], '22,3':[22, 3], '21,3':[21, 3], '23,2':[23, 2], '23,6':[23, 6], '25,1':[25, 1], '25,2':[25, 2], '25,6':[25, 6], '25,7':[25, 7], '35,3':[35, 3], '35,4':[35, 4], '36,4':[36, 4], '36,3':[36, 3]};

function frequencies(lst) {
    freqs = {};
    for(var i in lst) {
        if(freqs[lst[i]] == undefined)
            freqs[lst[i]] = 1;
        else
            freqs[lst[i]]++;
    }
